...
public class RenderBuilder {
    ...
    public RenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String uri) {
        this(context, okHttpClient, userAgent, uri, AudioManager.STREAM_MUSIC);
    }

    public RenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String uri, int streamType) {
        this.uri = uri;
