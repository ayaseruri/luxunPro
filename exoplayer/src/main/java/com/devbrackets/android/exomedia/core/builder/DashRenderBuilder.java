...
public class DashRenderBuilder extends RenderBuilder {
    ...
    public DashRenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String url) {
        this(context, okHttpClient, userAgent, url, AudioManager.STREAM_MUSIC);
    }

    public DashRenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String url, int streamType) {
        super(context, okHttpClient, userAgent, url, streamType);
    }

    @Override
    public void buildRenderers(EMExoPlayer player) {
        currentAsyncBuilder = new AsyncRendererBuilder(context, okHttpClient, userAgent, uri, player, streamType);
