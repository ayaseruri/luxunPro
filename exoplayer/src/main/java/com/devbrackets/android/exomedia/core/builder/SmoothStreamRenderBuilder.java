...
public class SmoothStreamRenderBuilder extends RenderBuilder {
    ...
    public SmoothStreamRenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String url) {
        this(context, okHttpClient, userAgent, url, AudioManager.STREAM_MUSIC);
    }

    public SmoothStreamRenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String url, int streamType) {
        super(context, okHttpClient, userAgent, getManifestUri(url), streamType);
    }
