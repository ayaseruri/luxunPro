...
public class HlsRenderBuilder extends RenderBuilder {
    ...
    public HlsRenderBuilder(Context context, OkHttpClient okHttpClient, String userAgent, String url) {
        this(context, okHttpClient, userAgent, url, AudioManager.STREAM_MUSIC);
    }

    public HlsRenderBuilder(Context context, OkHttpClient okHttpClient
            , String userAgent, String url, int streamType) {
