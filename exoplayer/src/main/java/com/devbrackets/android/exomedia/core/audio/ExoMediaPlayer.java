...
public class ExoMediaPlayer implements MediaPlayerApi {
    ...
    public ExoMediaPlayer(@NonNull Context context, @NonNull OkHttpClient okHttpClient) {
    ...
    protected RenderBuilder getRendererBuilder(@NonNull OkHttpClient okHttpClient, @NonNull MediaSourceType renderType, @NonNull Uri uri) {
        switch (renderType) {
            case HLS:
                return new HlsRenderBuilder(context, okHttpClient, getUserAgent(), uri.toString(), audioStreamType);
            case DASH:
                return new DashRenderBuilder(context, okHttpClient, getUserAgent(), uri.toString(), audioStreamType);
            case SMOOTH_STREAM:
                return new SmoothStreamRenderBuilder(context, okHttpClient, getUserAgent(), uri.toString(), audioStreamType);
            default:
                return new RenderBuilder(context, okHttpClient, getUserAgent(), uri.toString(), audioStreamType);
        }
    }
